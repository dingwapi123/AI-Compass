...
<template>
  <UApp>
    <div
      class="page-shell min-h-screen text-slate-900 dark:text-slate-100 transition-colors bg-white dark:bg-slate-950"
    >
      <header
      ...
      >
        <UContainer class="flex items-center justify-between py-4 gap-4">
          <NuxtLink
            to="/"
            class="flex items-center gap-2 font-semibold text-sky-600 dark:text-sky-300"
          >
      ...
      <footer
        class="border-t border-slate-200/80 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80"
      >
        <UContainer
          class="py-6 text-sm text-slate-500 dark:text-slate-400 flex flex-col sm:flex-row justify-between gap-2"
        >
